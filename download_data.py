...
#All
#['RHM_250_Test', 'RHM_500_Test', 'RHM_1000_Test', 'RHM_250_500_1000_train_test', 'UHDM_train_test', 'LSD_train_test', 'RMBQ', 'GoPro']
...
##GoPro dataset
GoPro = '1y4wvPdOG3mojpFCHTqLgriexhbjoWVkK'
...
for data in args.data:
    if data == 'GoPro':
        print('Downloading GoPro dataset!')
        gdown.download(id=GoPro, output='Datasets/GoPro/', quiet=False)
        print('Extracting data...')
        shutil.unpack_archive('Datasets/GoPro/GOPRO_Large.zip', 'Datasets')
        os.remove('Datasets/GoPro/GOPRO_Large.zip')
    ...
    if data == 'RMBQ':
        print('RMBQ Data!')
        gdown.download(id=RMBQ, output='Datasets/', quiet=False)
